...
?>
	...
	<br /><a href="/ASUTP/test/2/register.php">Регистрация</a>
<?php
} 
else 
{
	echo 'Вы вошли на сайт!<br /> Ваш Логин: '.$userinfo["login"].'<br />Выш E-mail: '.$userinfo["email"].'<br /> <a href="/ASUTP/test/2/index.php?exit=y">Выход</a>';
}
?>