...
<table align="center" style="width=450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" id="submit1" value="Генерировать отчёт" onclick="javascript:location.href='/ASUTP/localmenu/cshireports_result/<?php echo $id?>/'+document.getElementById('theDate1').value.replace('.','-').replace('.','-')"><br>
		</td>
	</tr>
</table>
...
<table align="center" style="width=450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="2" align="right">
			<input type="submit" value="Генерировать отчёт" onclick="javascript:location.href='/ASUTP/localmenu/cshireports_result/<?php echo $id?>/01-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 00:00:00' + '/'+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 24:00:00'"><br>
		</td>
	</tr>
</table>
...
<table align="center" style="width=450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" id="submit2" value="Генерировать отчёт" onclick="javascript:location.href='/ASUTP/localmenu/cshireports_result/<?php echo $id?>/' + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + ' 00:00:00' + '/' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') + ' 24:00:00'"><br>
		</td>
	</tr>
</table>