<script>
	function checkDate () {
		...
		if (isDate(document.getElementById('theDate4').value,mask))
			document.getElementById('alarm4').innerHTML="";
		else {
			document.getElementById('alarm4').innerHTML="Неверная дата";
			alarm_flag2=true;
		}
		if (isDate(document.getElementById('theDate5').value,mask))
			document.getElementById('alarm5').innerHTML="";
		else {
			document.getElementById('alarm5').innerHTML="Неверная дата";
			alarm_flag2=true;
		}
		if (alarm_flag2) {
...
<script type="text/javascript">
	  $(document).ready(function()
      {
		...
		$('#submit1').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_result/report_type=<?php echo $id?>_daily&date1='+document.getElementById('theDate1').value.replace('.','-').replace('.','-');
        });
		$('#submit2').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_trend/report_type=<?php echo $id?>_daily&date1='+document.getElementById('theDate1').value.replace('.','-').replace('.','-')+'&date2='+document.getElementById('theDate1').value.replace('.','-').replace('.','-');
        });
		$('#submit5').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_result/report_type=<?php echo $id?>_monthly&date1=01-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + '&date2='+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value;
        });
		$('#submit6').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_trend/report_type=<?php echo $id?>_monthly&date1=01-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + '&date2='+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value;
        });
		$('#submit7').click(function()
        {
          ...
          //test();
          //alert('2');
          //window.location.href='/ASUTP/localmenu/askureports_result/report_type=<?php echo $id?>_brigade&date1=' + document.getElementById('theDate4').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate5').value.replace('.','-').replace('.','-')+'&brigade='+document.getElementById('sel_brigade').value;
        });
		$('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_result/report_type=<?php echo $id?>_user&date1=' + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-');
        });
		$('#submit4').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/askureports_trend/report_type=<?php echo $id?>_user&date1=' + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-');
        });
      });
...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" value="Отчёт" id="submit1">
			<input type="submit" value="График" id="submit2">
        </td>
	</tr>
</table>
...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="2" align="right">
			<input type="submit" id="submit5" value="Отчёт">
			<input type="submit" id="submit6" value="График">
       	</td>
	</tr>
</table>
...
<p align="center" style="font-size: 12px; font-weight:bold;">Бригадный отчёт</p>
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	<tr>
		<td>
			<p>Бригада</p>
	...
	<tr>
		...
		<td align="right">
			<p><label name="alarm4" id="alarm4" style="color:red;vertical-align:center;"></label></p>
		</td>
		<td align="right">
			<input type="text" align="middle" value="<?php $dt=new DateTime(date('d.m.Y')); $dt->sub(new DateInterval('P1M'));echo $dt->format('d.m.Y');?>" name="theDate4" id="theDate4" maxlength="10" onKeyUp="checkDate()" onChange="checkDate()">
			<button id="trigger4">...</button>
			<script type="text/javascript">
				Calendar.setup(
					{
						inputField : "theDate4", // ID of the input field
						ifFormat : "%d.%m.%Y", // the date format
						//showsTime : true,
	...
	<tr>
		...
		<td align="right">
			<p><label name="alarm5" id="alarm5" style="color:red;vertical-align:center;"></label></p>
		</td>
		<td align="right">
			<input type="text" align="middle" value="<?php echo date('d.m.Y');?>" name="theDate5" id="theDate5" maxlength="10" onKeyUp="checkDate()" onChange="checkDate()">
			<button id="trigger5">...</button>
			<script type="text/javascript">
				Calendar.setup(
					{
						inputField : "theDate5", // ID of the input field
						ifFormat : "%d.%m.%Y", // the date format
						//showsTime : true,
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" value="Отчёт" id="submit7">
     </td>
	</tr>
</table>