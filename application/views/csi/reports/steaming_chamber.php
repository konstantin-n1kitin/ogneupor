	...
	<tr>
		...
		<td colspan="2" align="right">
			<select name="sel_teh" id="sel_teh">
				<option value=PLC-IN_A-20>Пропарочная камера 1. Температура</option>
				<option value=PLC-IN_A-21>Пропарочная камера 2. Температура</option>
				<option value=PLC-IN_A-22>Пропарочная камера 3. Температура</option>
				<option value=PLC-IN_A-28>Пропарочная камера 4. Температура</option>
			</select>
		</td>
	</tr>
	<tr>
