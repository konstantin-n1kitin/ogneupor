    ...
    <script type="text/javascript">
      $(document).ready(function()
      {
        $('#submit1').click(function()
        {
          ...
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>_daily&date1="+document.getElementById('theDate1').value.replace('.','-').replace('.','-')+"&mech_id="+document.getElementById('sel_scales').value+"&brigade="+document.getElementById('sel_brigade').value;
        });
        $('#submit2').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>_monthly&date1=01-" + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + '&date2='+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value +"&mech_id="+document.getElementById('sel_scales').value+"&brigade="+document.getElementById('sel_brigade').value;
        });
        $('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>_monthly&date1=" + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') +"&mech_id="+document.getElementById('sel_scales').value+"&brigade="+document.getElementById('sel_brigade').value;
        });
      });
    </script>
...
<p align="center" style="font-size: 12px; font-weight:bold;">Номер конвейерных весов</p>
<p align="center">
<select name="sel_scales" id="sel_scales">
...
<p align="center" style="font-size: 12px; font-weight:bold;">Бригада</p>
<p align="center">
...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" id="submit1" class="demo" value="Генерировать отчёт"><br>
		</td>
	</tr>
</table>
...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="2" align="right">
			<input type="submit" id="submit2" value="Генерировать отчёт"><br>
		</td>
	</tr>
</table>
