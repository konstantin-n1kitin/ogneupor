...
<table align="center" style="width=450px;margin: 10px auto;font-size: 12px;">
	<tr>
      ...
      <select name="MechName" id="MechName">
					<?php
						$sql = "select ID , MehName from Massive_MehNames order by MehName";
						...
						{
							$ID_mech = $rec[0];
							$MechName = iconv("Windows-1251" , "UTF-8", $rec[1]);		//Название механизма
							echo "<option value='$ID_mech'>$MechName";
//							echo "<option value='$ID_mech'>&nbsp;$MechName&nbsp;";
						}
						$db = null;
					?>
