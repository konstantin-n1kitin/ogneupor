	...
	function checkDate () {
      ...
      $(document).ready(function()
      {
        ...
        $('#submit1').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/cshireports/report_type=<?php echo $id?>&param_type=' + document.getElementById('gruz_type').value + '&date1=' + document.getElementById('theDate1').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate2').value.replace('.','-').replace('.','-');
        });
		$('#submit2').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href='/ASUTP/localmenu/trend_result/report_type=<?php echo $id?>&param_type=' + document.getElementById('gruz_type').value + '&date1=' + document.getElementById('theDate1').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate2').value.replace('.','-').replace('.','-');
        });
      });	
</script>
	...
	<tr>
		...
		<td colspan=2 align="right">
			<select name="gruz_type" id="gruz_type">
				<option value=0 <?php if ($param_type == 0) echo 'selected' ?> >Масса</option>
				<option value=1 <?php if ($param_type == 1) echo 'selected' ?> >Скорость</option>
				<option value=2 <?php if ($param_type == 2) echo 'selected' ?> >Ток</option> 
			</select>		
		</td>
	</tr>
	<tr>
