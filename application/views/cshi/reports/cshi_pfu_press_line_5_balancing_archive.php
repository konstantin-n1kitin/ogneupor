    ...
    <script type="text/javascript">
      $(document).ready(function()
      {
        ...
        $('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1=" + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') +"&scale_number="+document.getElementById('scale_number').value+"&zone="+document.getElementById('zone').value.replace('.','_').replace(',','_')+"&deviation=ALL";
        });
      });
   </script>
<script type="text/javascript">
	...
	<tr>
		...
		<td align="right">
			<select name="scale_number" id="scale_number">
				...
				<option value=3>641</option>
				<option value=4>640</option>
				<option value=5>596</option>
			</select>
		</td>
	</tr>
	<tr>
