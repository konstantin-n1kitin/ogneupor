...
<script type="text/javascript">
      $(document).ready(function()
      {
        $('#submit').click(function()
        {
          ...
          window.location.href='/ASUTP/localmenu/trend_result/report_type=<?php echo $report_type?>&date1=' + document.getElementById('theDate1').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate2').value.replace('.','-').replace('.','-');
        });
      });
    </script>
...
<table align="center" style="width:400px;margin: 10px auto;font-size: 12px;">
	...
	<tr>
		<td colspan="3" align="right">
			<input type="submit" id="submit" value="Генерировать график"><br>
		</td>
	</tr>
</table>