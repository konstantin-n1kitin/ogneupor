...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	<tr>
		...
		<td align="right">
			<input type="text" align="right" value="<?php $dt=new DateTime(date('')); $dt->sub(new DateInterval('P7D'));echo $dt->format('d.m.Y H:i');?>" name="theDate2" id="theDate2" maxlength="16" onKeyUp="checkDate()" onChange="checkDate()">
