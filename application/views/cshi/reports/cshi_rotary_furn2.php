	...
	<tr>
		...
		<td colspan="2" align="right">
			<select name="sel_teh" id="sel_teh">
				<option value="IN_A-IN_A_1">Общая температура газа</option>
				<option value="IN_A-IN_A_2">Общее давление газа</option>
				<option value="IN_A-IN_A_3">Разрежение в пылевой камере</option>
				<option value="IN_A-IN_A_4">Разрежение перед скруббером</option>
				<option value="IN_A-IN_A_5">Разряжение перед циклоном левый канал</option>
				<option value="IN_A-IN_A_6">Разряжение перед циклоном правый канал</option>
				<option value="IN_A-IN_A_7">Разряжение перед электрофильтром левый канал</option>
				<option value="IN_A-IN_A_8">Разряжение перед электрофильтром правый канал</option>
				<option value="IN_A-IN_A_9">Разряжение перед дымососом</option>
				<option value="IN_A-IN_A_10">Температура в пылевой камере</option>
				<option value="IN_A-IN_A_11">Анализ на «СО»</option>
				<option value="IN_A-IN_A_12">Температура перед циклоном левый канал</option>
				<option value="IN_A-IN_A_13">Температура перед циклоном правый канал</option>
				<option value="IN_A-IN_A_14">Температура перед электрофильтром левый канал</option>
				<option value="IN_A-IN_A_15">Температура перед электрофильтром правый канал</option>
				<option value="IN_A-IN_A_16">Температура перед дымососом</option>
				<option value="IN_A-IN_A_17">Расход вентиляционного воздуха</option>
				<option value="IN_A-IN_A_18">Расход газа</option>
				<option value="IN_A-IN_A_19">Давление газа</option>
				<option value="IN_A-IN_A_20">Весы</option>
				<option value="IN_A-IN_A_21">Нагрузка питателя</option>
				<option value="IN_A-IN_A_22">Уровень в бункере выгрузки пыли</option>
				<option value="IN_A-IN_A_23">ИМ газ</option>
				<option value="IN_A-IN_A_24">ИМ воздух</option>
				<option value="IN_A-IN_A_25">Расход сжатого воздуха на газоочистку</option>
			</select>
		</td>
	</tr>
	<tr>
