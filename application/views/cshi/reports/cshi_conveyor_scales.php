    ...
    <script type="text/javascript">
      $(document).ready(function()
      {
        $('#submit1').click(function()
        {
          ...
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>_daily&date1="+document.getElementById('theDate1').value.replace('.','-').replace('.','-')+"&mech_id="+document.getElementById('sel_scales').value;
        });
        ...
        $('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>_monthly&date1=" + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') +"&mech_id="+document.getElementById('sel_scales').value;
        });
      });
    </script>
