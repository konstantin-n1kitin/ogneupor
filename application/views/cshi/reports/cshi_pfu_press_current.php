...
<script type="text/javascript">
	  $(document).ready(function()
      {
		...
		$('#submit1').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1="+document.getElementById('theDate1').value.replace('.','-').replace('.','-')+"&press_number="+document.getElementById('press_number').value+"&limit_current="+document.getElementById('limit_current').value;
        });
		$('#submit5').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1=01-" + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 00:00:00' + '&date2='+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 24:00:00'+"&press_number="+"&press_number="+document.getElementById('press_number').value+"&limit_current="+document.getElementById('limit_current').value;
        });
		$('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1=" + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') +"&press_number="+document.getElementById('press_number').value+"&limit_current="+document.getElementById('limit_current').value;
        });
      });
...
<table align="center" style="width:450px;margin: 10px auto;font-size: 12px;">
	<tr>
		...
		<td align="right">
			<select name="press_number" id="press_number">
	...
	<tr>
		...
		<td align="right">
			<input name="limit_current" id="limit_current" type="text" size=3 value=85>
		</td>
	</tr>
</table>
