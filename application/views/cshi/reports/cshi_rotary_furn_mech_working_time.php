...
<!--		<td></td> -->
      ...
      <select name="MechName" id="MechName">
				<option value="IN_D-IN_D_8">Дымосос 25</option>
				<option value="IN_D-IN_D_9">Дымосос 26</option>
				<option value="IN_D-IN_D_10">Дымосос 27</option>
				<option value="IN_D-IN_D_11">Дымосос 28</option>
      </select>
		</td>
	</tr>
	<tr>
