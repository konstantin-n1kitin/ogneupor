	...
	<tr>
		...
		<td colspan="2" align="right">
			<select name="sel_teh" id="sel_teh">
				<option value=T-T_SIGNAL_38>Температура подаваемого воздуха сушила №4</option>
				<option value=T-T_SIGNAL_37>Температура свода сушила №4</option>
				<option value=T-T_SIGNAL_40>Температура сушила №4 боковая(Левая)</option>
				<option value=T-T_SIGNAL_39>Температура сушила №4 боковая(Правая)</option>
			</select>
		</td>
	</tr>
	<tr>
