...
<table align="center" style="width=550px;margin: 10px auto;font-size: 12px;">
	<tr>
      ...
      <select name="MechName" id="MechName">
				<option value=IN_D-D_SIGNAL_IN_21>Вентилятор 4 (Отбор воздуха)</option>
				<option value=IN_D-D_SIGNAL_IN_22>Вентилятор 5 (Подача горячего воздуха в сушило)</option>
				<option value=IN_D-D_SIGNAL_IN_23>Вентилятор 10 (Разрежение в подподовом пространстве)</option>
				<option value=IN_D-D_SIGNAL_IN_24>Вентилятор 11 (Отбор дымовых газов)</option>
				<option value=IN_D-D_SIGNAL_IN_25>Вентилятор 12 (Отбор дымовых газов)</option>
				<option value=IN_D-D_SIGNAL_IN_26>Вентилятор 13 (Воздух на поддержание горения в печи)</option>
				<option value=IN_D-D_SIGNAL_IN_27>Вентилятор 14 (Воздух на поддержание горения в печи)</option>
				<option value=IN_D-D_SIGNAL_IN_28>Вентилятор 17 (Воздух распределенной подачи)</option>
				<option value=IN_D-D_SIGNAL_IN_29>Вентилятор 18 (Воздух сосредоточенной подачи)</option>
				<option value=IN_D-D_SIGNAL_IN_30>Вентилятор 26 (Воздух в подподовый коридор)</option>
				<option value=IN_D-D_SIGNAL_IN_31>Вентилятор 27 (Воздух в подподовый коридор)</option>
				<option value=IN_D-D_SIGNAL_IN_32>Вентилятор 28 (Воздух в подподовый коридор)</option>
      </select>
		</td>
	</tr>
	<tr>
