    ...
    <script type="text/javascript">
      $(document).ready(function()
      {
        $('#submit1').click(function()
        {
          ...
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1="+document.getElementById('theDate1').value.replace('.','-').replace('.','-');
        });
        $('#submit2').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1=01-" + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 00:00:00' + '&date2='+ getMaxDate(document.getElementById('sel_year').value, document.getElementById('sel_month').value-1) + '-' + document.getElementById('sel_month').value + '-' + document.getElementById('sel_year').value + ' 23:59:59';
        });
        $('#submit3').click(function()
        {
          ...
          //test();
          //alert('2');
          window.location.href="/ASUTP/localmenu/cshireports_result/report_type=<?php echo $id?>&date1=" + document.getElementById('theDate2').value.replace('.','-').replace('.','-') + ' 00:00:00' + '&date2=' + document.getElementById('theDate3').value.replace('.','-').replace('.','-') + ' 23:59:59';
        });
      });
    </script>
