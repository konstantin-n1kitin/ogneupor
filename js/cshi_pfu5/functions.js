...
//------------------------------------------------------------------------------
      function UpdateElements(ServerAnswer)
      {
		...
		document.getElementById('sum').innerHTML=parseInt(document.getElementById('pfu5_r11').innerHTML)+parseInt(document.getElementById('pfu5_r21').innerHTML)+parseInt(document.getElementById('pfu5_r31').innerHTML)+parseInt(document.getElementById('pfu5_r41').innerHTML)+parseInt(document.getElementById('pfu5_r51').innerHTML);
      }
//------------------------------------------------------------------------------
			  ...
			  switch(state)
              {
				...
				case ('3'):
                    switch (ClassName)
                    {
					  ...
					  case ('mixer'):
						if (Element.className != ClassName+'_on') Element.className = ClassName+'_on';
						document.getElementById(element+"_text").innerHTML = "Пуск смесителя НС";
                      break;
                      default:
                        Element.className = ClassName+'_off';
                      break;  
				...
				case ('5'):
                    switch (ClassName)
                    {
					  case ('mixer'):
						if (Element.className != ClassName+'_on') Element.className = ClassName+'_on';
						document.getElementById(element+"_text").innerHTML = "Пуск смесителя ВС";
                      break;
                      default:
                        Element.className = ClassName+'_off';
                      break;  
...
//------------------------------------------------------------------------------
      ...
      {       
        ...
        if (request!=null)
        {
          ...
          request.open("POST", "/ASUTP/php/GetOPCData.php?mnemo=9", false); 
          request.send(null);
        }
        else
